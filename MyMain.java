...
public class MyMain {
	public static void main(String[] args) {
	    ...
	    driver.findElement(By.id("email_create")).sendKeys("sinacengiz@yandex.com");
	    ...
	    driver.findElement(By.id("phone")).sendKeys("+905079318993");
	    driver.findElement(By.id("phone_mobile")).sendKeys("+2025478965");
